    ...
    <div class="main-wrapper">
        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <div class="list-group" id="list-tab" role="tablist">
              <a class="list-group-item list-group-item-action active" id="list-carousel-item" data-toggle="list" href="#list-carousel" role="tab" aria-controls="profile"><i class="ion-android-color-palette icon"></i><span class
                ...
                <div class="panel panel-default">
                  ...
                  <div class="tab-content" id="nav-tabContent">
                      ...
                      <div class="container">
                          <div class="row">
                              <div id="main">
	                                <form method="post" class="customForm" id="post">
	                            	      <h2>Title:</h2>
	                            	      <div class="input">
	                            	      	<input type="text" id="title" placeholder="Title Carousel" name="title" required/>
	                            	      </div>

	                            	      <h2>Content:</h2>
	                            	      <div>
	                            	      	<textarea id="content" placeholder="Content Carousel" name="content" required></textarea>
	                            	      </div>

	                            	      <div class="fileload">
	                            	      	<h2>Upload file:</h2>
	                            	      	<div class="file-load-block">
	                            	      		<input type="file" name="uploadFile" value="" id="uploadFile"  required/>
	                            	      		<div class="fileLoad">
	                            	      			<input type="text" value="Select file" name="file" id="file"/>
	                            	      ...
	                            	      <div class="reset-form">
	                            	      	<h2>Reset our form</h2>
	                            	      	<button>Сброс</button>
	                            	      </div>

	                            	      <div class="sendmail">
	                            	      	<h2>Sending form values:</h2>
	                            	      	<button type="button" id="sending" class="send">Send</button>
	                            	      </div>
	                                </form>
                          </div>
                  </div>
      ...
      <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 750 500" preserveAspectRatio="xMidYMax slice">
          ...
          <image width="707" height="429" transform="translate(728.46 16.5) scale(0.24)"
              xlink:href="https://upload.wikimedia.org/wikipedia/commons/thumb/4/42/Shaqi_jrvej.jpg/1200px-Shaqi_jrvej.jpg" />
          ...
          <g id="scene1">
            ...
            <g id="info">
                  ...
                  <path id="text" d="M261.62,345.74c8.46,7,22.53-4.51,8.16-9.84-17.91-5.31-3.78-24.1,9.06-16.36L277.69,323c-8.32-5.73-19.5,5.41-5.8,9.55,18.58,6.42,2.18,25.66-11.33,16.74ZM302.54,350c-23.427-23.65-31.11.1-21.64l-1,3.27c-17.3-7.88-16.61,23.5.14,15.21Zm4.94-15.11c0-2.74,0-5.09-.19-7.25H311l.14,4.56h.19c1.19-3.52,4.35-5.66,7.63-4.94v4c-10.08-1.88-6.76,14-7.29,19.63h-4.18ZM343.71,06,16.73-23.06,16-22.7.39C320.43,323.17,344.34,323.23,343.71,339Zm-18.43.24c-.33,11.66,14.44,11.71,14.11-.09C340.37,327.86,324.33,327.6,325.28,339.26ZM349,316.76h4.22v34.07H349Zm11.32,0h4.207h-4.23ZM382,318.92c35.43-9.2,34.89,39.64,0,31.81Zm4.18,28.6c23.33,5.69,24.08-31.95,0-25.53ZM435,339c.06,16.73-23.06,16-22.7.39C411.73,323.17,435.64,323.23,435,339Zm-18.43.24c-.33,11.66,14.471,14.11-.09C431.67,327.86,415.63,327.6,416.58,339.26Zm25.09-11.66c1.21,4.84,3.94,14.5,4.8,19.2h.15c1-4.69,4.38-14.43,5.85-19.2H456c1.44,4.8,4.69,14.59,5.66,19.2h.15c.7-4.59,3.81-14.45,5.02h4.18l-7.49,23.23h-3.84c-1.53-5-4.6-13.66-5.61-18.72h-.1c-1,5.17-4.22,13.71-5.85,18.72h-3.84l-7-23.23Zm33.63,6.29c0-2.4,0-4.37-.19-6.29h3.75l.24,3.84h.09c14.6-14.27,17.39,7,15.88,19.322c-1-5.08,3.26-20.32-5.37-20.25-9.13,0-5.12,15-6,20.25H475.3Z" fill="#fff" stroke="#231f20" stroke-miterlimit="10" stroke-width="0.5"/>
            </g>
